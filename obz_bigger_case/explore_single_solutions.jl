...
results_df = DataFrame(;
    ...
    loss_of_load_h2_demand=Float64[],
    penalty_tot_loss_of_load=Float64[],
    investment_cost=Float64[],
    operational_cost=Float64[],
    investment_cost_storage=Float64[],
    investment_cost_renewable=Float64[],
    investment_cost_non_renewable=Float64[],
    investment_cost_electrolyzer=Float64[],
    non_renewable_capacity=Float64[],
)
...
function main()
    ...
    for solver in solvers
        ...
        penalty_tot_loss_of_load = JuMP.value(energy_problem_benchmark.model[:penalty_loss_of_load])
