...
DuckDB.query(connection,"DELETE FROM asset
...
DuckDB.query(connection,"DELETE FROM asset_commission
WHERE LOWER(asset) LIKE '%ens%'
   OR LOWER(asset) LIKE '%smr%';")
...
DuckDB.query(connection,"DELETE FROM asset_milestone
WHERE LOWER(asset) LIKE '%ens%'
   OR LOWER(asset) LIKE '%smr%';")
...
DuckDB.query(connection,"DELETE FROM asset_both
WHERE LOWER(asset) LIKE '%ens%'
   OR LOWER(asset) LIKE '%smr%';")
...
DuckDB.query(connection,"DELETE FROM flow
...
DuckDB.query(connection,"DELETE FROM flow_commission
WHERE LOWER(from_asset) LIKE '%ens%'
   OR LOWER(from_asset) LIKE '%smr%';")
...
DuckDB.query(connection,"DELETE FROM flow_milestone
WHERE LOWER(from_asset) LIKE '%ens%'
   OR LOWER(from_asset) LIKE '%smr%';")
