...
def plot_values_grid(results_dict, value, savepath):
    ...
    for col_idx, method in enumerate(METHODS):
        ...
        ax.set_title(
            "Convex hull" if method == "convex_hull"
            else "Bounded conical hull",
            fontsize=16,
        )
    ...
    fig.supxlabel("Number of representative periods", fontsize=15, y=-0.05)
    fig.supylabel(VALUE_MAP[value], fontsize=15, x=-0.02)
