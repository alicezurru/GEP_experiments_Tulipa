...
def plot_values_quantiles_grid(stats_dict, case_df, value, savepath):
    ...
    for col_idx, col in enumerate(COLS):
        ...
        for row_idx, method in enumerate(METHODS):
            ...
            plot_panel(ax, stats_df, case_df, value, method, rp_to_pos)
...
def main():
    ...
    stats = {
        "DISTANT": pd.read_csv(SCRIPT_DIR / "stats_dist.csv"),
        "HALFMIXED": pd.read_csv(SCRIPT_DIR / "stats_hmix.csv"),
        "CLOSE": pd.read_csv(SCRIPT_DIR / "stats_cl.csv"),
        "MIXED": pd.read_csv(SCRIPT_DIR / "stats_mix.csv"),
    }
