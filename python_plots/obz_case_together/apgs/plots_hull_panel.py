...
YLIM_MAP = {
     "rel_regret": (0.0, 0.4),
     "total_steps_loss_of_load": (-100,750),
     "total_lol": (-100,2000),
}
...
def main():
    ...
    stats_sets = {
    "NO APGS": pd.read_csv(SCRIPT_DIR / "stats_n.csv"),
    "APGS, α = 0": pd.read_csv(SCRIPT_DIR / "stats_a0.csv"),
    "APGS, α = 0.005": pd.read_csv(SCRIPT_DIR / "stats_a0.005.csv"),
    "APGS, α = 0.01": pd.read_csv(SCRIPT_DIR / "stats_a0.01.csv"),
    }

    results = {
        "NO APGS": pd.read_csv(SCRIPT_DIR / "results_n.csv"),
        "APGS, α = 0": pd.read_csv(SCRIPT_DIR / "results_a0.csv"),
        "APGS, α = 0.005": pd.read_csv(SCRIPT_DIR / "results_a0.005.csv"),
        "APGS, α = 0.01": pd.read_csv(SCRIPT_DIR / "results_a0.01.csv"),
    }
