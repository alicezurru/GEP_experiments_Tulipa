...
def main():
    ...
    stats_sets = {
        ...
        "DAWC": pd.read_csv(SCRIPT_DIR / "stats_dawc.csv"),
        "APGS": pd.read_csv(SCRIPT_DIR / "stats_apgs.csv"),
    }
    ...
    results = {
        ...
        "DAWC": pd.read_csv(SCRIPT_DIR / "results_dawc.csv"),
        "APGS": pd.read_csv(SCRIPT_DIR / "results_apgs.csv"),
    }
